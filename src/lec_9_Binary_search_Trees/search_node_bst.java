...
public class search_node_bst {
    public static boolean searchInBST(BinaryTreeNode<Integer> root, int k) {
        ...
        BinaryTreeNode<Integer> rr = searchInBST2( root,  k);
    ...
    public static BinaryTreeNode<Integer> searchInBST2(BinaryTreeNode<Integer> root, int k){
        if (root == null ){
            return null;
        }
        if (root.data == k ){
        ...
        if (root.data < k ){
            ...
            return searchInBST2(root.right , k);
        }
        //System.out.println(root.data);
        return searchInBST2(root.left , k);
    }
}
