...
public class zigZagTree {
    public static void printZigZag(BinaryTreeNode<Integer> root){
        ...
        while(!pendingNodes.empty()){
            Stack<BinaryTreeNode<Integer>> childrenNodes = new Stack<>();
            while(!pendingNodes.empty()){
                BinaryTreeNode<Integer> workingNode = pendingNodes.pop();
                System.out.print(workingNode.data + " ");
                if(i % 2 != 0){
                    if(workingNode.left != null)
                        childrenNodes.push(workingNode.left);
                    if(workingNode.right != null)
                        childrenNodes.push(workingNode.right);
                }else{
                    if(workingNode.right != null)
                        childrenNodes.push(workingNode.right);
                    if(workingNode.left != null)
