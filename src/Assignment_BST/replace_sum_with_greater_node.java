...
public class replace_sum_with_greater_node {
    ...
    public static int replaceWithLargerNodesSum(BinaryTreeNode<Integer> root , int sum) {
        ...
        // System.out.println(highSum(sumRoot , root.data));
        // root.data = highSum(sumRoot , root.data);
...
//    public static int highSum(BinaryTreeNode<Integer> root , int k){
//         if (root == null){
//             return 0;
//         }
...
//             x = root.data;
//         }
//         x+=highSum(root.left , k);
//         int y = 0;
//         y+= highSum(root.right , k);
//         return x+y;
//     }
}
